...
import { Search, ShoppingCart, Moon, Sun, Loader, BookOpen, User, LogOut, Package } from 'lucide-react';
            ...
            <div className="relative" ref={profileRef}>
              ...
              {showProfileMenu && currentUser && (
                <div className="absolute top-12 right-0 w-56 bg-white dark:bg-gray-800 rounded-xl shadow-xl dark:shadow-2xl border border-gray-100 dark:border-gray-700 overflow-hidden z-50 animate-in fade-in zoom-in-95 duration-200">
                  ...
                  <div className="py-1">
                      {isAdmin && (
                        <Link to="/admin" onClick={() => setShowProfileMenu(false)} className="px-4 py-2 hover:bg-gray-50 dark:hover:bg-gray-700 font-bold text-sm text-primary flex items-center gap-2 transition-colors">
                          <User className="w-4 h-4 text-primary" /> Admin Dashboard
                        </Link>
                      )}
                      <Link to="/orders" onClick={() => setShowProfileMenu(false)} className="px-4 py-2 hover:bg-gray-50 dark:hover:bg-gray-700 font-medium text-sm text-gray-700 dark:text-gray-200 flex items-center gap-2 transition-colors">
